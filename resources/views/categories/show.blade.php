    ...
    <div class="row">
        <div class="breadcrumb-container">
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('home') }}">Вопросы и ответы</a>
                </li>
        ...
        <div class="fb-heading">
            <i class="fa fa-folder"></i> Категория: {{ $category->name }}
        ...
        @foreach($category->articles as $article)
            <div class="panel panel-default">
                ...
                <div class="article-read-more">
                    <a href="{{ route('articles.show', [$article->slug, $article->id]) }}" class="btn btn-default btn-wide">Подробнее...</a>
                </div>
            </div>
        @endforeach
