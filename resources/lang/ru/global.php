...
return [
    ...
    'clickHereToVerify' => 'Щелкните здесь, чтобы проверить',
    'create' => 'Создать',
    ...
    'thankYouForUsingOurApplication' => 'Спасибо за использование нашего веб-сайта',
    'timeFrom' => 'Время от',
    'timeTo' => 'Время',
    'toggleNavigation' => 'Переключить навигацию',
    'user_name' => 'Имя',
    'verifyYourEmail' => 'Подтвердите свой адрес электронной почты',
    'verifyYourUser' => 'Чтобы завершить регистрацию - сайт просит вас подтвердить вашу электронную почту',
    'view' => 'Просмотр',
    'view_file' => 'Просмотреть файл',
    'year' => 'Год',
    'yes' => 'Да',
    'youAreLoggedIn' => 'Вы вошли в систему!',
    'yourAccountNeedsAdminApproval' => 'Для входа в вашу учетную запись необходимо разрешение администратора',
    'submit' => 'Отправить',
    'datatables'                           => [
        'copy'          => 'Копия',
        'csv'           => 'CSV',
    ...
    'app_imported_rows_to_table'           => 'Импортировано :rows строков в таблицу :table',
    'app_parse_csv'                        => 'Парсить CSV',
    'asset'                                => 'Asset',
    'assets'                               => 'Assets',
    ...
    'confirm_password'                     => 'Потвердить пароль',
