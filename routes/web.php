...
Route::get('questions/check_slug', 'ArticleController@check_slug')->name('articles.check_slug');
Route::get('questions/{slug}/{article}', 'ArticleController@show')->name('articles.show');
Route::get('questions', 'ArticleController@index')->name('articles.index');
